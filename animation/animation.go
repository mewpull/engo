package animation // import "engo.io/engo/animation"
...
type AnimationComponent struct {
	...
	Drawables        []render.Drawable // Renderables
	Animations       map[string][]int  // All possible animations
	CurrentAnimation []int             // The current animation
}

func NewAnimationComponent(drawables []render.Drawable, rate float32) AnimationComponent {
...
func (ac *AnimationComponent) Cell() render.Drawable {
...
func (a *AnimationSystem) Add(basic *ecs.BasicEntity, anim *AnimationComponent, render *render.RenderComponent) {
